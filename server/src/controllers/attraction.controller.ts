...
const handleAddAttraction=async(req:Request,res:Response,next:NextFunction)=>{
    try{
      ...
      const attraction=await attractionServices.createAttractionIntoDB(attractionPayload)
